...
main() {
	...
	test('Gets a full file name from a path', () {
		...
		final actualFileName = Path.getFileName(
			Path.combine([Randomiser.nextString(), Randomiser.nextString(), expectedFileName]));
	...
	test('Returns a file name without changes when it has no extension to discard', () {
