...
void _runTestsForScreen(String screenName, Widget Function() screenBuilder) {
  testWidgets(
      '$screenName: goes forward through all the available slides and then backward again',
      (tester) async {
  ...
  testWidgets(
      '$screenName: displays a helping dialog by clicking on the information icon',
      (tester) async {
...
Future<MapEntry<String, String>> _assureInfoDialogRendering(
    WidgetAssistant assistant) async {
  final infoBtnFinder =
