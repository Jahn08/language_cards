...
void main() {
    ...
    testWidgets('Loads empty user settings from the storage of shared preferences', (_) async {
    ...
    testWidgets('Saves and loads user settings to the storage of shared preferences', (_) async {
