...
class DialogListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) => new AlertDialog(
      actions: buttons,
      contentPadding:
          isShrunk ? EdgeInsets.zero : _defaultAlertDialog.contentPadding,
      titlePadding:
          isShrunk ? EdgeInsets.zero : _defaultAlertDialog.titlePadding,
      title: title == null
          ? null
...
class _ScrollView extends StatelessWidget {
  ...
  Widget build(BuildContext context) => isShrunk
      ? new SingleChildScrollView(child: child, padding: EdgeInsets.zero)
